...
<body>
    ...
    <!-- Application Scripts -->
    <?= $this->Html->script('rmp/validation.js?v=1.1')?>
    <?= $this->Html->script('rmp/global.js?v=1.1') ?>
    <?= $this->Html->script('rmp/mantenedores.js')?>
    ...
    <script>
     $(document).ready(function () {
         ...
         $.validator.setDefaults({
             ignore: '.select2-offscreen, .select2-input, input[type="text"]:hidden, input[type="hidden"], .select2-container:hidden~select',
