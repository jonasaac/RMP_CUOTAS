...
?>
    ...
    <div class="col-md-12">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                    <div class="input-group">
                      <select class="form-control input-xs" style="width: 100%" name="nave_id" id="nave-id" data-placeholder="Seleccione una Nave" lang="es">
                        <option value></option>
                        <option value="<?=$marea->nave_id?>" selected="selected"><?=$marea->nave->nombre?></option>
                      </select>
     ...
     <div class="form-group">
            ...
            <div class="col-sm-9">
                    <div class="input-group">
                      <select class="form-control input-xs" style="width: 100%" name="capitan_id" id="capitan-id" data-placeholder="Seleccione un Capitán" lang="es">
                          <option value></option>
                          <option value="<?=$marea->capitan_id?>" selected="selected"><?=$marea->capitan->nombre_completo?></option>
                      </select>
                    <div class="input-group-btn">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                    <div class="input-group">
                      <select class="form-control input-xs" style="width: 100%" name="puerto_id" id="puerto-id" data-placeholder="Seleccione un Puerto" lang="es">
                          <option value></option>
                          <option value="<?=$marea->puerto_id?>" selected="selected"><?=$marea->puerto->nombre?></option>
                      </select>
                    <div class="input-group-btn">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
            <textarea id="observaciones" name="observaciones" class="form-control"><?=$marea->observaciones?></textarea>
          </div>
        </div>
      </form>
    </div>
