...
<div class="row" id="<?=$hash_id?>">
    <form id="estado-cuota-form" class="form-horizontal">
    <div class="col-md-12">
        <legend>Estado de Cuota de Pesca</legend>
    </div>
    <div class="col-md-12">
            <div class="row">
                <div class="col-xs-12">
                        ...
                        <div class="col-sm-9">
                          <div class="input-group">
                            <select class="form-control input-xs" name="macro_zona_id" id="macro-zona-id" data-placeholder="Seleccione una Macro Zona" lang="es" style="width: 100%;">
                                <option value=<?=$estadoCuota->macro_zona_id?>><?=$estadoCuota->macro_zona->nombre?></option>
                            </select>
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <select class="form-control input-xs" name="especie_id" id="especie-id" data-placeholder="Seleccione una Especie" lang="es" style="width: 100%;">
                                    <option value="<?=$estadoCuota->especie_id?>"><?=$estadoCuota->especie->nombre?></option>
                                </select>
                                <div class="input-group-btn">
                                    <?php if (array_in_array(['admin_nave_add'], $current_user['privilegios'])): ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                          ...
                          <div class="input-container">
                            <input type="text"
                                name="unidades[0][_joinData][cantidad]"
                                class="form-control input-xs" placeholder="Ingrese la cantidad"
                                value="<?=$estadoCuota->unidades[0]->_joinData->cantidad?>"/>
                            <label>TON</label>
                          </div>
                        </div>
                    </div>
...
<script>
  $(document).ready(function () {
    ...
    $('#fecha-estado-date-container', $thisModal).data('DateTimePicker').date(moment.utc('<?=$estadoCuota->fecha_estado->format(DateTime::ISO8601)?>'));
